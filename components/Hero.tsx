  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <h1 className="font-heading text-5xl md:text-6xl mb-6">Bell Suites, eleganza e<br />comfort nel cuore di Roma</h1>
        ...
        <button className="bg-bianco text-blu px-8 py-3 font-semibold cursor-pointer transition-colors duration-150 hover:bg-bianco/80 hover:text-blu rounded-md">Scopri</button>
      </div>
    </section>
  );
}
